...
BINARY_SENSOR_DESCRIPTIONS: tuple[Web888BinarySensorEntityDescription, ...] = (
    ...
    # === v1.2.0: Config Feature Flags (WebSocket only) ===
    Web888BinarySensorEntityDescription(
        key="cfg_gps_enabled",
        translation_key="cfg_gps_enabled",
        name="GPS Enabled",
        entity_category=EntityCategory.DIAGNOSTIC,
        icon="mdi:satellite-variant",
        value_fn="cfg_gps_enabled",
        websocket_only=True,
    ),
    Web888BinarySensorEntityDescription(
        key="cfg_gps_correction",
        translation_key="cfg_gps_correction",
        name="GPS Correction",
        entity_category=EntityCategory.DIAGNOSTIC,
        icon="mdi:tune",
        value_fn="cfg_gps_correction",
        websocket_only=True,
    ),
    Web888BinarySensorEntityDescription(
        key="cfg_drm_enabled",
        translation_key="cfg_drm_enabled",
        name="DRM Enabled",
        entity_category=EntityCategory.DIAGNOSTIC,
        icon="mdi:radio",
        value_fn="cfg_drm_enabled",
        websocket_only=True,
    ),
    Web888BinarySensorEntityDescription(
        key="cfg_wspr_enabled",
        translation_key="cfg_wspr_enabled",
        name="WSPR Enabled",
        entity_category=EntityCategory.DIAGNOSTIC,
        icon="mdi:broadcast",
        value_fn="cfg_wspr_enabled",
        websocket_only=True,
    ),
    Web888BinarySensorEntityDescription(
        key="cfg_wspr_spot_log",
        translation_key="cfg_wspr_spot_log",
        name="WSPR Spot Logging",
        entity_category=EntityCategory.DIAGNOSTIC,
        icon="mdi:file-document",
        value_fn="cfg_wspr_spot_log",
        websocket_only=True,
    ),
    Web888BinarySensorEntityDescription(
        key="cfg_wspr_gps_grid",
        translation_key="cfg_wspr_gps_grid",
        name="WSPR Auto-Update Grid",
        entity_category=EntityCategory.DIAGNOSTIC,
        icon="mdi:grid",
        value_fn="cfg_wspr_gps_grid",
        websocket_only=True,
    ),
    Web888BinarySensorEntityDescription(
        key="cfg_server_enabled",
        translation_key="cfg_server_enabled",
        name="Server Enabled",
        entity_category=EntityCategory.DIAGNOSTIC,
        icon="mdi:server",
        value_fn="cfg_server_enabled",
        websocket_only=True,
    ),
    Web888BinarySensorEntityDescription(
        key="cfg_airband",
        translation_key="cfg_airband",
        name="Airband Mode",
        entity_category=EntityCategory.DIAGNOSTIC,
        icon="mdi:airplane",
        value_fn="cfg_airband",
        websocket_only=True,
    ),
    Web888BinarySensorEntityDescription(
        key="cfg_use_static_ip",
        translation_key="cfg_use_static_ip",
        name="Static IP Mode",
        entity_category=EntityCategory.DIAGNOSTIC,
        icon="mdi:ip-network",
        value_fn="cfg_use_static_ip",
        websocket_only=True,
    ),
    Web888BinarySensorEntityDescription(
        key="cfg_sdr_hu_listed",
        translation_key="cfg_sdr_hu_listed",
        name="SDR.hu Listed",
        entity_category=EntityCategory.DIAGNOSTIC,
        icon="mdi:web",
        value_fn="cfg_sdr_hu_listed",
        websocket_only=True,
    ),
    Web888BinarySensorEntityDescription(
        key="cfg_kiwisdr_listed",
        translation_key="cfg_kiwisdr_listed",
        name="KiwiSDR.com Listed",
        entity_category=EntityCategory.DIAGNOSTIC,
        icon="mdi:web",
        value_fn="cfg_kiwisdr_listed",
        websocket_only=True,
    ),
)
